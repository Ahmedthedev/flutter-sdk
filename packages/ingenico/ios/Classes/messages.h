...
+ (instancetype)makeWithId:(NSString *)id
    ...
    displayHints:(FLTDisplayHintsPaymentItem *)displayHints;
...
@property(nonatomic, strong) FLTDisplayHintsPaymentItem * displayHints;
@end
...
+ (instancetype)makeWithId:(NSString *)id
    type:(FLTType)type
    displayHints:(FLTDisplayHintsProductFields *)displayHints
    dataRestrictions:(FLTDataRestrictions *)dataRestrictions;
@property(nonatomic, copy) NSString * id;
@property(nonatomic, assign) FLTType type;
@property(nonatomic, strong) FLTDisplayHintsProductFields * displayHints;
@property(nonatomic, strong) FLTDataRestrictions * dataRestrictions;
@end
