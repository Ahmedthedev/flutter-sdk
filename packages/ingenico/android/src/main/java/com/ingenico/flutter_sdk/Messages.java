...
public class Messages {
  ...
  public static class BasicPaymentProduct {
    ...
    private @NonNull DisplayHintsPaymentItem displayHints;
    public @NonNull DisplayHintsPaymentItem getDisplayHints() { return displayHints; }
    public void setDisplayHints(@NonNull DisplayHintsPaymentItem setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"displayHints\" is null.");
      }
    ...
    public static class Builder {
      ...
      public @NonNull Builder setDisplayHints(@NonNull DisplayHintsPaymentItem setterArg) {
        this.displayHints = setterArg;
        return this;
      }
    ...
    static @NonNull BasicPaymentProduct fromMap(@NonNull Map<String, Object> map) {
      ...
      pigeonResult.setDisplayHints(DisplayHintsPaymentItem.fromMap((Map)displayHints));
      return pigeonResult;
    }
  }
  ...
  public static class PaymentProductField {
    ...
    private @NonNull DisplayHintsProductFields displayHints;
    public @NonNull DisplayHintsProductFields getDisplayHints() { return displayHints; }
    public void setDisplayHints(@NonNull DisplayHintsProductFields setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"displayHints\" is null.");
      }
      this.displayHints = setterArg;
    ...
    private @NonNull DataRestrictions dataRestrictions;
    public @NonNull DataRestrictions getDataRestrictions() { return dataRestrictions; }
    public void setDataRestrictions(@NonNull DataRestrictions setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"dataRestrictions\" is null.");
      }
    ...
    public static class Builder {
      ...
      public @NonNull Builder setDisplayHints(@NonNull DisplayHintsProductFields setterArg) {
        this.displayHints = setterArg;
        return this;
      }
      private @Nullable DataRestrictions dataRestrictions;
      public @NonNull Builder setDataRestrictions(@NonNull DataRestrictions setterArg) {
        this.dataRestrictions = setterArg;
        return this;
      }
    ...
    static @NonNull PaymentProductField fromMap(@NonNull Map<String, Object> map) {
      ...
      Object displayHints = map.get("displayHints");
      pigeonResult.setDisplayHints(DisplayHintsProductFields.fromMap((Map)displayHints));
      Object dataRestrictions = map.get("dataRestrictions");
      pigeonResult.setDataRestrictions(DataRestrictions.fromMap((Map)dataRestrictions));
      return pigeonResult;
    }
  }
  ...
  public static class DisplayHintsProductFields {
    ...
    static @NonNull DisplayHintsProductFields fromMap(@NonNull Map<String, Object> map) {
      ...
      pigeonResult.setTooltip(Tooltip.fromMap((Map)tooltip));
      Object formElement = map.get("formElement");
      pigeonResult.setFormElement(FormElement.fromMap((Map)formElement));
      return pigeonResult;
    }
  }
      ...
      } else 
{
  ...
  public interface Api {
    @NonNull SessionResponse createClientSession(SessionRequest request);
    @NonNull void _passThrough(PaymentProductField a, BasicPaymentProduct b, AbstractValidationRule c, ValueMap d, PaymentProductFieldDisplayElement e);
